      ...
      <div className="container mx-auto py-10">
        ...
        <div className="grid md:grid-cols-12 gap-8">
          ...
          >
            <Card className="p-4">
              <div 
                className="aspect-square rounded-full mx-auto flex items-center justify-center mb-4 relative overflow-hidden"
                style={{
                    ...
                    >
                      {chat.type === "ai" && (
                        <div className="flex items-center gap-2 mb-2">
                          <div 
                            className="h-8 w-8 rounded-full flex items-center justify-center relative overflow-hidden"
